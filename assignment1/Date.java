...
public class Date {
    ...
    // constants used in getSuffix()
    public static final int FIRST         = 1;
    public static final int SECOND        = 2;
    public static final int THIRD         = 3;
    public static final int TWENTY_FIRST  = 21;
    public static final int TWENTY_SECOND = 22;
    ...
    /**
     * Get the suffix of the indicated day of the month.
     * @param day An integer to indicate the day of the month.
     * @return A String to indicate "st" for 1, "nd" for 2, "rd" for 3, "th" for 4, etc¡­
     */
    public String getSuffix(int day) {
        String suffix;
        if(day >= FIRST && day <= THIRTY_FIRST) {
            if(day == FIRST || day == TWENTY_FIRST || day == THIRTY_FIRST) {
                suffix = "st";
            }
            else if(day == SECOND || day == TWENTY_SECOND) {
                suffix = "nd";
            }
            else if(day == THIRD || day == TWENTY_THIRD) {
                suffix = "rd";
            }
            else {
                suffix = "th";
            ...
            throw new IllegalArgumentException("Error: Invalid Date::day.");
        }
        return suffix;
    }
}